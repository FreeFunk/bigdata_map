...
@TableName("bigdata_beidou_car_trace_bk_rec")
public class BigdataBeidouCarTraceBkRec implements Serializable{
	 ...
	 * 属性描述:中断开始经纬度
	 */
	@TableField(value="START_LN_LAT",exist=true)
	String startLnLat;

	/**
	 * 属性描述:中断结束经纬度
	 */
	@TableField(value="END_LN_LAT",exist=true)
	String endLnLat;

	/**
	 * 属性描述:两点间距离
	 */
	@TableField(value="POINT_DISTANCE",exist=true)
	java.math.BigDecimal pointDistance;

	/**
	 * 属性描述:轨迹中断类型(0,不完整，1,漂移)
	 */
	@TableField(value="BREAK_TYPE",exist=true)
	String breakType;
	...
	public String getStartLnLat(){
		return this.startLnLat;
	}

	public void setStartLnLat(String startLnLat){
		this.startLnLat=startLnLat;
	}


	public String getEndLnLat(){
		return this.endLnLat;
	}

	public void setEndLnLat(String endLnLat){
		this.endLnLat=endLnLat;
	}


	public java.math.BigDecimal getPointDistance(){
		return this.pointDistance;
	}

	public void setPointDistance(java.math.BigDecimal pointDistance){
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", startLnLat=").append(startLnLat);			
			sb.append(", endLnLat=").append(endLnLat);			
			sb.append(", pointDistance=").append(pointDistance);			
			sb.append(", breakType=").append(breakType);			
    ...
    public boolean equals(Object that) {
        ...
        BigdataBeidouCarTraceBkRec other = (BigdataBeidouCarTraceBkRec) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getStartLnLat() == null ? other.getId() == null : this.getStartLnLat().equals(other.getStartLnLat()))		
				        		&&(this.getEndLnLat() == null ? other.getId() == null : this.getEndLnLat().equals(other.getEndLnLat()))		
				        		&&(this.getPointDistance() == null ? other.getId() == null : this.getPointDistance().equals(other.getPointDistance()))		
				        		&&(this.getBreakType() == null ? other.getId() == null : this.getBreakType().equals(other.getBreakType()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getStartLnLat() == null) ? 0 : getStartLnLat().hashCode());		
		        result = prime * result + ((getEndLnLat() == null) ? 0 : getEndLnLat().hashCode());		
		        result = prime * result + ((getPointDistance() == null) ? 0 : getPointDistance().hashCode());		
		        result = prime * result + ((getBreakType() == null) ? 0 : getBreakType().hashCode());		

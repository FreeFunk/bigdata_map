...
public class BigdataDangerRoadClsMonth implements Serializable{
	...
	String dangerRoadClsName;

	/**
	 * 属性描述:危险路段超过次数
	 */
	@TableField(value="DANGER_ROAD_PASS_NUM",exist=true)
	Integer dangerRoadPassNum;
	...
	public String getDangerRoadClsName(){
		return this.dangerRoadClsName;
	}

	public void setDangerRoadClsName(String dangerRoadClsName){
		this.dangerRoadClsName=dangerRoadClsName;
	}


	public Integer getDangerRoadPassNum(){
		return this.dangerRoadPassNum;
	}

	public void setDangerRoadPassNum(Integer dangerRoadPassNum){

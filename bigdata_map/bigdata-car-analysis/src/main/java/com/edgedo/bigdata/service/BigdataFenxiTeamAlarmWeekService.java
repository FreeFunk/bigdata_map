...
public class BigdataFenxiTeamAlarmWeekService {
	...
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor=Exception.class)
	public void insertOrUpdate(BigdataFenxiTeamAlarmWeek bigdataFenxiTeamAlarmWeek) {
		BigdataFenxiTeamAlarmWeek bigdataFenxiTeamAlarmWeek1 = mapper.selectByOwnerCarDayIdAndType(bigdataFenxiTeamAlarmWeek);
		if(bigdataFenxiTeamAlarmWeek1==null){
			bigdataFenxiTeamAlarmWeek.setId(Guid.guid());
			bigdataFenxiTeamAlarmWeek.setCreateTime(new Date());
			mapper.insert(bigdataFenxiTeamAlarmWeek);
		}else {
			bigdataFenxiTeamAlarmWeek.setId(bigdataFenxiTeamAlarmWeek1.getId());
			bigdataFenxiTeamAlarmWeek.setUpdateTime(new Date());
			mapper.updateByFenPian(bigdataFenxiTeamAlarmWeek);
		}
	}
}

 ...
 * @Description北斗数据接入月统计
 * @Author 床前明月光
 * @Date 2019/8/5 11:38
 **/
@ConditionalOnProperty(
        value = {"timetask.beidou.BigdataBeidouComMonthAnalysis.enable"},
        havingValue = "true",
...
public class BigdataBeidouComMonthAnalysis {
    ...
    @Scheduled(cron = "${timetask.beidou.BigdataBeidouComMonthAnalysis.cron.updateComMonthCheck}")

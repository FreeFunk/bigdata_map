...
@TableName("bigdata_fenxi_car_month")
public class BigdataFenxiCarMonth implements Serializable{
	...
	java.lang.Integer runTimeLength;
	
	/**
	 * 属性描述:行驶时长文本
	 */
	@TableField(value="RUN_TIME_LENGTH_TEXT",exist=true)
	java.lang.String runTimeLengthText;
	 ...
	 * 属性描述:车辆排名
	 */
	@TableField(value="CAR_RANKING",exist=true)
	java.lang.String carRanking;
	...
	public void setTransitType(java.lang.String transitType){
	...
	public java.lang.Integer getRunTimeLength(){
		return this.runTimeLength;
	}
	
	public void setRunTimeLength(java.lang.Integer runTimeLength){
		this.runTimeLength=runTimeLength;
	}
	
	
	public java.lang.String getRunTimeLengthText(){
		return this.runTimeLengthText;
	}
	
	public void setRunTimeLengthText(java.lang.String runTimeLengthText){
	...
	public java.lang.String getCarRanking(){
		return this.carRanking;
	}
	
	public void setCarRanking(java.lang.String carRanking){
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", carRanking=").append(carRanking);			
    ...
    public boolean equals(Object that) {
        ...
        BigdataFenxiCarMonth other = (BigdataFenxiCarMonth) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getCarRanking() == null ? other.getId() == null : this.getCarRanking().equals(other.getCarRanking()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getCarRanking() == null) ? 0 : getCarRanking().hashCode());		

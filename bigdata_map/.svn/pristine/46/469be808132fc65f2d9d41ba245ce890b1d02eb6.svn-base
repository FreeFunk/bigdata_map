...
@TableName("bigdata_fatigue_analysis_sum_count")
public class BigdataFatigueAnalysisSumCount implements Serializable{
    ...
    public boolean equals(Object that) {
        ...
        BigdataFatigueAnalysisSumCount other = (BigdataFatigueAnalysisSumCount) that;
        boolean flag = true;
        return  flag

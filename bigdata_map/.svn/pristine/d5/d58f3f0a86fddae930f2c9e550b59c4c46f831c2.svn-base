...
public class BigdataTimeAnalysis implements Serializable{
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", firstDangerMileage=").append(firstDangerMileage);			
			sb.append(", secondDangerMileage=").append(secondDangerMileage);			
			sb.append(", thirdDangerMileage=").append(thirdDangerMileage);			
        sb.append("]");
        return sb.toString();
    }
    ...
    public boolean equals(Object that) {
        ...
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getFirstDangerMileage() == null ? other.getId() == null : this.getFirstDangerMileage().equals(other.getFirstDangerMileage()))		
				        		&&(this.getSecondDangerMileage() == null ? other.getId() == null : this.getSecondDangerMileage().equals(other.getSecondDangerMileage()))		
				        		&&(this.getThirdDangerMileage() == null ? other.getId() == null : this.getThirdDangerMileage().equals(other.getThirdDangerMileage()))		
				;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getFirstDangerMileage() == null) ? 0 : getFirstDangerMileage().hashCode());		
		        result = prime * result + ((getSecondDangerMileage() == null) ? 0 : getSecondDangerMileage().hashCode());		
		        result = prime * result + ((getThirdDangerMileage() == null) ? 0 : getThirdDangerMileage().hashCode());		
		;
        return result;
    }

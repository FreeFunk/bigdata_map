...
public class BigdataDriverDrawInfo implements Serializable{
	 ...
	 * 属性描述:社保状态
	 */
	@TableField(value="SIN_STATE",exist=true)
	String sinState;
	 ...
	 * 属性描述:行驶里程描述
	 */
	@TableField(value="RUN_MILEAGE_DESC",exist=true)
	String runMileageDesc;

	/**
	 * 属性描述:行驶时长描述
	 */
	@TableField(value="RUN_TIME_LENGTH_DESC",exist=true)
	String runTimeLengthDesc;

	/**
	 * 属性描述:行驶速度描述
	 */
	@TableField(value="RUN_SPEED_DESC",exist=true)
	String runSpeedDesc;

	/**
	 * 属性描述:常去城市描述
	 */
	@TableField(value="STOP_CITY_DESC",exist=true)
	String stopCityDesc;

	/**
	 * 属性描述:告警情况描述
	 */
	@TableField(value="ALARM_DESC",exist=true)
	String alarmDesc;

	/**
	 * 属性描述:安全作业描述
	 */
	@TableField(value="SAFETY_WORK_DESC",exist=true)
	String safetyWorkDesc;

	/**
	 * 属性描述:继续教育描述
	 */
	@TableField(value="LEARN_DESC",exist=true)
	String learnDesc;

	/**
	 * 属性描述:保障情况描述
	 */
	@TableField(value="SIN_DESC",exist=true)
	String sinDesc;

	/**
	 * 属性描述:驾驶行为分析
	 */
	@TableField(value="DRIVING_DESC",exist=true)
	String drivingDesc;
	...
	public void setDrivingDesc(String drivingDesc) {
		this.drivingDesc = drivingDesc;
	}
	...
	public String getIsRealState(){
		return this.isRealState;
	}

	public void setIsRealState(String isRealState){
	...
	public String getRunTimeLengthLevel(){
		return this.runTimeLengthLevel;
	}

	public void setRunTimeLengthLevel(String runTimeLengthLevel){
	...
	public String getRunMileageLevel(){
		return this.runMileageLevel;
	}

	public void setRunMileageLevel(String runMileageLevel){
	...
	public String getDangerRunLevel(){
		return this.dangerRunLevel;
	}

	public void setDangerRunLevel(String dangerRunLevel){
	...
	public String getSinState(){
		return this.sinState;
	}

	public void setSinState(String sinState){
		this.sinState=sinState;
	}


	public String getSafetrainLevel(){
		return this.safetrainLevel;
	}

	public void setSafetrainLevel(String safetrainLevel){
	...
	public String getStopCityLevel(){
		return this.stopCityLevel;
	}

	public void setStopCityLevel(String stopCityLevel){
	...
	public String getRunSpeedLevel(){
		return this.runSpeedLevel;
	}

	public void setRunSpeedLevel(String runSpeedLevel){
	...
	public String getJyLevel(){
		return this.jyLevel;
	}

	public void setJyLevel(String jyLevel){
		this.jyLevel=jyLevel;
	}


	public String getRunMileageDesc(){
		return this.runMileageDesc;
	}

	public void setRunMileageDesc(String runMileageDesc){
		this.runMileageDesc=runMileageDesc;
	}


	public String getRunTimeLengthDesc(){
		return this.runTimeLengthDesc;
	}

	public void setRunTimeLengthDesc(String runTimeLengthDesc){
		this.runTimeLengthDesc=runTimeLengthDesc;
	}


	public String getRunSpeedDesc(){
		return this.runSpeedDesc;
	}

	public void setRunSpeedDesc(String runSpeedDesc){
		this.runSpeedDesc=runSpeedDesc;
	}


	public String getStopCityDesc(){
		return this.stopCityDesc;
	}

	public void setStopCityDesc(String stopCityDesc){
		this.stopCityDesc=stopCityDesc;
	}
	...
	public String getSafetyWorkDesc(){
		return this.safetyWorkDesc;
	}

	public void setSafetyWorkDesc(String safetyWorkDesc){
		this.safetyWorkDesc=safetyWorkDesc;
	}
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", sinState=").append(sinState);			
			...
			sb.append(", runMileageDesc=").append(runMileageDesc);			
			sb.append(", runTimeLengthDesc=").append(runTimeLengthDesc);			
			sb.append(", runSpeedDesc=").append(runSpeedDesc);			
			sb.append(", stopCityDesc=").append(stopCityDesc);			
			sb.append(", alarmDesc=").append(alarmDesc);			
			sb.append(", safetyWorkDesc=").append(safetyWorkDesc);			
			sb.append(", learnDesc=").append(learnDesc);			
			sb.append(", sinDesc=").append(sinDesc);			
    ...
    public boolean equals(Object that) {
        ...
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getSinState() == null ? other.getId() == null : this.getSinState().equals(other.getSinState()))		
				        		...
				        		&&(this.getRunMileageDesc() == null ? other.getId() == null : this.getRunMileageDesc().equals(other.getRunMileageDesc()))		
				        		&&(this.getRunTimeLengthDesc() == null ? other.getId() == null : this.getRunTimeLengthDesc().equals(other.getRunTimeLengthDesc()))		
				        		&&(this.getRunSpeedDesc() == null ? other.getId() == null : this.getRunSpeedDesc().equals(other.getRunSpeedDesc()))		
				        		&&(this.getStopCityDesc() == null ? other.getId() == null : this.getStopCityDesc().equals(other.getStopCityDesc()))		
				        		&&(this.getAlarmDesc() == null ? other.getId() == null : this.getAlarmDesc().equals(other.getAlarmDesc()))		
				        		&&(this.getSafetyWorkDesc() == null ? other.getId() == null : this.getSafetyWorkDesc().equals(other.getSafetyWorkDesc()))		
				        		&&(this.getLearnDesc() == null ? other.getId() == null : this.getLearnDesc().equals(other.getLearnDesc()))		
				        		&&(this.getSinDesc() == null ? other.getId() == null : this.getSinDesc().equals(other.getSinDesc()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getSinState() == null) ? 0 : getSinState().hashCode());		
		        ...
		        result = prime * result + ((getRunMileageDesc() == null) ? 0 : getRunMileageDesc().hashCode());		
		        result = prime * result + ((getRunTimeLengthDesc() == null) ? 0 : getRunTimeLengthDesc().hashCode());		
		        result = prime * result + ((getRunSpeedDesc() == null) ? 0 : getRunSpeedDesc().hashCode());		
		        result = prime * result + ((getStopCityDesc() == null) ? 0 : getStopCityDesc().hashCode());		
		        result = prime * result + ((getAlarmDesc() == null) ? 0 : getAlarmDesc().hashCode());		
		        result = prime * result + ((getSafetyWorkDesc() == null) ? 0 : getSafetyWorkDesc().hashCode());		
		        result = prime * result + ((getLearnDesc() == null) ? 0 : getLearnDesc().hashCode());		
		        result = prime * result + ((getSinDesc() == null) ? 0 : getSinDesc().hashCode());		

...
public class SysXianquService {
	 ...
	 * @return
	 */
	public SysXianqu selectByXianquNameAndCityName(String cityName, String xianquName) {
		Map<String,Object> param = new HashMap<String,Object>();
		param.put("mapCity",cityName);
		param.put("mapXianqu",xianquName);
		return mapper.selectByXianquNameAndCityName(param);
    }

	public SysXianqu selectXianQuId(String xianQuId) {
		return mapper.selectXianQuId( xianQuId);
	}
}

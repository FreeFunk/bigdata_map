...
@TableName("bigdata_fenxi_team_month")
public class BigdataFenxiTeamMonth implements Serializable{
	...
	java.lang.String runMileageTopThree;
	...
	public java.lang.Integer getCountCarNum(){
		return this.countCarNum;
	}
	
	public void setCountCarNum(java.lang.Integer countCarNum){
	...
	public java.lang.String getRunMileageTopThree(){
		return this.runMileageTopThree;
	}
	
	public void setRunMileageTopThree(java.lang.String runMileageTopThree){
    ...
    public boolean equals(Object that) {
        ...
        BigdataFenxiTeamMonth other = (BigdataFenxiTeamMonth) that;
        boolean flag = true;
        return  flag

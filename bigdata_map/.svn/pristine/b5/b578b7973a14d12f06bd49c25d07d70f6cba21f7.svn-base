...
@TableName("bigdata_car_stop_record")
public class BigdataCarStopRecord implements Serializable{
	 ...
	 * 属性描述:停留分钟数
	 */
	@TableField(value="STOP_MINITE_NUM",exist=true)
	java.lang.Integer stopMiniteNum;
	...
	public java.lang.Integer getStopMiniteNum(){
		return this.stopMiniteNum;
	}
	
	public void setStopMiniteNum(java.lang.Integer stopMiniteNum){
		this.stopMiniteNum=stopMiniteNum;
	}
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", stopMiniteNum=").append(stopMiniteNum);			
    ...
    public boolean equals(Object that) {
        ...
        BigdataCarStopRecord other = (BigdataCarStopRecord) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getStopMiniteNum() == null ? other.getId() == null : this.getStopMiniteNum().equals(other.getStopMiniteNum()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getStopMiniteNum() == null) ? 0 : getStopMiniteNum().hashCode());		

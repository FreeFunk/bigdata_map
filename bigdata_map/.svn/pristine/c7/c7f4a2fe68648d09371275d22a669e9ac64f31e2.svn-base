...
public class BigdataFenxiCarMonth implements Serializable{
	...
	public BigDecimal getRunTimeLengthHour() {
		return runTimeLengthHour;
	}

	public void setRunTimeLengthHour(BigDecimal runTimeLengthHour) {
	...
	public String getCarRanking(){
		return this.carRanking;
	}

	public void setCarRanking(String carRanking){

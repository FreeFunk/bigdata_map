...
public class BigdataDriverDrawInfoController extends BaseController{
	...
	/*根据司机ID和年查询*/
	@RequestMapping(value = "/loadByDriverIdAndYear",method = RequestMethod.POST)
	public ModelAndView  loadByDriverIdAndYear(BigdataDriverDrawInfo driverDrawInfo ){
		ModelAndView modelAndView = new ModelAndView();
		BigdataDriverDrawInfo bigdataDriverDrawInfo = service.loadByDriverIdAndYear(driverDrawInfo);
		return buildResponse(modelAndView,bigdataDriverDrawInfo);
	}

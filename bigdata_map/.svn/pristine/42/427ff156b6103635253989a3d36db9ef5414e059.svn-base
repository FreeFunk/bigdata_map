...
@TableName("bigdata_fenxi_team_alarm_month")
public class BigdataFenxiTeamAlarmMonth implements Serializable{
	 ...
	 * 属性描述:所属企业月统计ID
	 */
	@TableField(value="OWNER_TEAM_MONTH_ID",exist=true)
	java.lang.String ownerTeamMonthId;
	...
	public java.lang.String getOwnerTeamMonthId(){
		return this.ownerTeamMonthId;
	}
	
	public void setOwnerTeamMonthId(java.lang.String ownerTeamMonthId){
		this.ownerTeamMonthId=ownerTeamMonthId;
	}
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", ownerTeamMonthId=").append(ownerTeamMonthId);			
    ...
    public boolean equals(Object that) {
        ...
        BigdataFenxiTeamAlarmMonth other = (BigdataFenxiTeamAlarmMonth) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		&&(this.getCreateTime() == null ? other.getId() == null : this.getCreateTime().equals(other.getCreateTime()))		
				        		&&(this.getUpdateTime() == null ? other.getId() == null : this.getUpdateTime().equals(other.getUpdateTime()))		
				        		&&(this.getOwnerTeamMonthId() == null ? other.getId() == null : this.getOwnerTeamMonthId().equals(other.getOwnerTeamMonthId()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getOwnerTeamMonthId() == null) ? 0 : getOwnerTeamMonthId().hashCode());		

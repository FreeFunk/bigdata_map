...
import com.edgedo.alarm.mapper.IclogsMapper;
...
@Service
public class IclogsService {

    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    @Autowired
    IclogsMapper iclogsMapper ;
    /**
     * 查询某个小时的报警信息
     * @param date
     * @return
     */
    public List<Iclogs> listIcLogs(Date date){
     ...
     /*   param.put("searchTime4",searchTime4);
        ...
        return iclogsMapper.listIcLogs(param);
    }
